...
#ifdef WSPEC_BIG_RAM
#define WSPEC_16K_SIZE         0x3FF0  // must be aligned
static uint8_t ucHeap[ (configTOTAL_HEAP_SIZE - WSPEC_16K_SIZE) ];
#else // WSPEC_BIG_RAM
...
#ifdef WSPEC_BIG_RAM
BlockLink_t *px16FreeBlock;
memset(0x20000000, 0, WSPEC_16K_SIZE);
#endif // WSPEC_BIG_RAM
...
#ifdef WSPEC_BIG_RAM
	pucHeapEnd = pucAlignedHeap + xTotalHeapSize - WSPEC_16K_SIZE;
#else // WSPEC_BIG_RAM
...
#ifdef WSPEC_BIG_RAM
	pxFirstFreeBlock->xBlockSize = xTotalHeapSize - heapSTRUCT_SIZE - WSPEC_16K_SIZE;

        // we add the 0x20000000 to 0x20003FFF as free block
        px16FreeBlock = (BlockLink_t *)0x20000000;
        px16FreeBlock->xBlockSize = WSPEC_16K_SIZE - heapSTRUCT_SIZE;
        px16FreeBlock->pxNextFreeBlock = pxEnd;
          
        pxFirstFreeBlock->pxNextFreeBlock = px16FreeBlock;
#else // WSPEC_BIG_RAM
